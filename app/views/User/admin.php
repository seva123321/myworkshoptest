        ...
        <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
          ...
          <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
            ...
            <ul class="nav flex-column">
              ...
              <!-- <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="#" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">
                  <svg class="bi">
                    <use xlink:href="#file-earmark" />
                  </svg>
              ...
              <!-- <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="#" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="true">
                  <svg class="bi">
                    <use xlink:href="#cart" />
                  </svg>
                  Products
        ...
        <div class="tab-content" id="v-pills-tabContent">
          ...
          <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab" tabindex="0">
            <form id="createProduct">
              ...
              <div class="mb-1">
                <label for="exampleFormControlInput1" class="form-label">артикул</label>
                <input name="articul" type="number" class="form-control" placeholder="">
              </div>
              <div class="mb-1">
          ...
          <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab" tabindex="0">
            ...
            <!-- <div class="header__search">
              <i class="fa-brands fa-searchengin fa-bounce fa-2x"></i>
              <input type="search" placeholder="поиск">
              <div class="header__result d-none"></div>
            </div> -->
            <nav class="navbar navbar-expand-lg bg-body-tertiary navbar_mg">
              <div class="container-fluid">
                <span class="navbar-text h4">Поиск товаров в базе данных</span>
